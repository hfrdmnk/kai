...
`;let w=`linear(0, 0.008 1.1%, 0.034 2.3%, 0.134 4.9%, 0.264 7.3%, 0.683 14.3%, 0.797 16.5%, 0.89 18.6%, 0.967 20.7%, 1.027 22.8%, 1.073 25%, 1.104 27.3%, 1.123 30.6%, 1.119 34.3%, 1.018 49.5%, 0.988 58.6%, 0.985 65.2%, 1 84.5%, 1)`;var T=new DOMParser,E=(e,t)=>{let n=T.parseFromString(t,`image/svg+xml`);e.appendChild(document.importNode(n.documentElement,!0))},D=typeof CSS<`u`&&CSS.supports(`anchor-name: --a`),O=(e,t)=>{let n=window.innerWidth/2,r=window.innerHeight/2,i=e>=n,a=t>=r;return a&&i?`bottom-right`:a&&!i?`bottom-left`:!a&&i?`top-right`:`top-left`},k=(e,t,n)=>{let r=t.getBoundingClientRect();n===`top-left`||n===`top-right`?(e.style.top=`${r.top}px`,e.style.bottom=`auto`):(e.style.top=`auto`,e.style.bottom=`${document.documentElement.clientHeight-r.bottom}px`),n===`bottom-right`||n===`top-right`?(e.style.left=`auto`,e.style.right=`${document.documentElement.clientWidth-r.left+8}px`,e.style.flexDirection=`row-reverse`,e.style.transformOrigin=`right center`):(e.style.left=`${r.right+8}px`,e.style.right=`auto`,e.style.flexDirection=`row`,e.style.transformOrigin=`left center`)},A={shrinkMs:120,expandMs:400,blurPx:4,scaleDown:.3},j=async(e,t,n=``)=>{let r=e.querySelector(`svg`);r&&await r.animate([{transform:`scale(1)`,filter:`blur(0)`},{transform:`scale(${A.scaleDown})`,filter:`blur(${A.blurPx}px)`}],{duration:A.shrinkMs,easing:`ease-in`,fill:`forwards`}).finished,e.replaceChildren(),E(e,t),e.style.background=n,e.style.color=n?`var(--white)`:``,e.style.borderColor=n;let i=e.querySelector(`svg`);i&&i.animate([{transform:`scale(${A.scaleDown})`,filter:`blur(${A.blurPx}px)`},{transform:`scale(1)`,filter:`blur(0)`}],{duration:A.expandMs,easing:w})},M=5,N=(e,t,n)=>Math.max(t,Math.min(n,e)),P=(e,t)=>{let n=N(e/window.innerWidth,0,1),r=N(t/window.innerHeight,0,1),i=n*(1-r),a=(1-n)*(1-r),o=(1-n)*r,s=n*r,c=e=>`${22-18*e*e}px`;return`${c(i)} ${c(a)} ${c(o)} ${c(s)}`};let F=(e,t)=>{let n=t.initialCorner,r=!1,i=null,a=!1,o=[],s=document.createElement(`button`);s.className=`kai-fab`,s.setAttribute(`data-corner`,n),s.setAttribute(`aria-label`,`Toggle UI annotator`),s.setAttribute(`aria-pressed`,`false`),s.setAttribute(`aria-expanded`,`false`),E(s,y);let c=document.createElement(`span`);c.className=`kai-fab-badge`,c.style.display=`none`,s.appendChild(c);let l=document.createElement(`div`);l.className=`kai-fab-actions`,l.style.display=`none`;let u=document.createElement(`button`);u.className=`kai-fab-action`,u.setAttribute(`aria-label`,`Copy as Markdown`),E(u,x);let d=document.createElement(`button`);d.className=`kai-fab-action`,d.setAttribute(`aria-label`,`Clear all`),E(d,b);let f=document.createElement(`div`);f.className=`kai-tooltip`,f.style.display=`none`,f.style.fontFamily=`var(--font-sans)`,e.appendChild(f);let p=(e,t)=>{f.textContent=t,f.style.display=``;let r=e.getBoundingClientRect(),i=n===`top-left`||n===`top-right`;f.style.left=`${r.left+r.width/2}px`,f.style.transform=`translateX(-50%)`,i?(f.style.top=`${r.bottom+6}px`,f.style.bottom=`auto`):(f.style.top=`auto`,f.style.bottom=`${document.documentElement.clientHeight-r.top+6}px`)},m=()=>{f.style.display=`none`};u.addEventListener(`mouseenter`,()=>p(u,`Copy as Markdown`)),u.addEventListener(`mouseleave`,m),d.addEventListener(`mouseenter`,()=>p(d,`Clear all`)),d.addEventListener(`mouseleave`,m),l.appendChild(u),l.appendChild(d),e.appendChild(s),e.appendChild(l);let h=!1,g=!1,_=0,v=0,T=0,A=0;D?(s.addEventListener(`pointerdown`,e=>{e.preventDefault(),g=!0,h=!1,_=e.clientX,v=e.clientY;let t=s.getBoundingClientRect();T=t.left,A=t.top,s.setPointerCapture(e.pointerId),i?.cancel(),i=s.animate([{transform:`scale(1)`},{transform:`scale(0.9)`}],{duration:120,easing:`ease-out`,fill:`forwards`})}),s.addEventListener(`pointermove`,e=>{if(!g)return;let t=e.clientX-_,o=e.clientY-v,u=Math.sqrt(t*t+o*o);if(!h&&u>M&&(h=!0,i?.cancel(),s.style.position=`fixed`,s.style.left=`${T}px`,s.style.top=`${A}px`,s.style.right=`auto`,s.style.bottom=`auto`,s.classList.add(`kai-fab--dragging`),c.style.display!==`none`&&!a&&(a=!0,c.animate([{scale:`1`},{scale:`0`}],{duration:200,easing:`ease-out`,fill:`forwards`}),s.classList.remove(`kai-fab--has-badge`)),s.style.borderRadius=P(T+22,A+22),r&&W()),h){let e=Math.max(0,Math.min(window.innerWidth-44,T+t)),i=Math.max(0,Math.min(window.innerHeight-44,A+o));s.style.left=`${e}px`,s.style.top=`${i}px`,s.style.borderRadius=P(e+22,i+22),r&&l.style.display!==`none`&&k(l,s,n)}}),s.addEventListener(`pointerup`,e=>{if(g)if(g=!1,s.classList.remove(`kai-fab--dragging`),h){h=!1;let o=O(e.clientX,e.clientY),l=parseFloat(s.style.left),u=parseFloat(s.style.top),d=s.style.borderRadius;s.style.left=``,s.style.top=``,s.style.right=``,s.style.bottom=``,s.style.position=``,s.style.borderRadius=``,n=o,s.setAttribute(`data-corner`,n),t.onCornerChange(n);let f=c.style.display!==`none`;f&&s.classList.add(`kai-fab--has-badge`);let p=s.getBoundingClientRect(),m=getComputedStyle(s).borderRadius;f&&s.classList.remove(`kai-fab--has-badge`);let g=l-p.left,_=u-p.top;i?.cancel(),i=s.animate([{transform:`translate(${g}px, ${_}px) scale(0.95)`,borderRadius:d},{transform:`translate(0, 0) scale(1)`,borderRadius:m}],{duration:600,easing:w}),r&&i.finished.then(()=>U()).catch(()=>{}),setTimeout(()=>{a=!1,c.style.display!==`none`&&(s.classList.add(`kai-fab--has-badge`),c.animate([{scale:`0`},{scale:`1`}],{duration:400,easing:w,fill:`forwards`}))},200)}else t.onToggle(),i?.cancel(),i=s.animate([{transform:`scale(0.9)`},{transform:`scale(1)`}],{duration:600,easing:w})})):(s.addEventListener(`pointerdown`,()=>{i?.cancel(),i=s.animate([{transform:`scale(1)`},{transform:`scale(0.9)`}],{duration:120,easing:`ease-out`,fill:`forwards`})}),s.addEventListener(`pointerup`,()=>{i?.cancel(),i=s.animate([{transform:`scale(0.9)`},{transform:`scale(1)`}],{duration:600,easing:w})}),s.addEventListener(`click`,e=>{e.stopPropagation(),t.onToggle()}));let N=document.createElement(`span`);N.setAttribute(`aria-live`,`polite`),N.style.cssText=`position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;`,e.appendChild(N);let F=null,I=()=>{j(u,x),F=null},L=()=>{F&&clearTimeout(F),j(u,S,`var(--color-success)`),N.textContent=`Copied`,F=setTimeout(()=>{I(),N.textContent=``},2e3)};u.addEventListener(`click`,e=>{e.stopPropagation(),t.onCopyMarkdown()});let R=!1,z=null,B=()=>{R=!1,j(d,b),z=null};d.addEventListener(`click`,e=>{e.stopPropagation(),R?(z&&clearTimeout(z),B(),t.onClearAll()):(R=!0,j(d,C,`var(--color-danger)`),z=setTimeout(B,3e3))});let V=e=>{e>0?(c.textContent=String(e),c.style.display=`flex`,a||s.classList.add(`kai-fab--has-badge`)):(c.style.display=`none`,a=!1,s.classList.remove(`kai-fab--has-badge`))},H=()=>n===`bottom-right`||n===`top-right`,U=()=>{o.forEach(e=>e.cancel()),o=[],l.style.display=`flex`,requestAnimationFrame(()=>{k(l,s,n);let e=H()?`12px`:`-12px`;[u,d].forEach((t,n)=>{let r=t.animate([{transform:`translateX(${e}) scale(0.8)`,opacity:0},{transform:`translateX(0) scale(1)`,opacity:1}],{duration:400,easing:w,delay:n*50,fill:`both`});o.push(r)})})},W=()=>{m(),o.forEach(e=>e.cancel()),o=[];let e=H()?`8px`:`-8px`,t=[u,d].map((t,n)=>t.animate([{transform:`translateX(0) scale(1)`,opacity:1},{transform:`translateX(${e}) scale(0.8)`,opacity:0}],{duration:150,easing:`ease-in`,delay:n*30,fill:`forwards`}));o=t,Promise.all(t.map(e=>e.finished)).then(()=>{l.style.display=`none`,t.forEach(e=>e.cancel()),o=[]})};return{updateBadge:V,setActive:e=>{r=e,s.setAttribute(`aria-pressed`,String(e)),s.setAttribute(`aria-expanded`,String(e)),e?(s.classList.add(`kai-fab--active`),U()):(s.classList.remove(`kai-fab--active`),W())},updateActionStates:e=>{let t=e===0;u.disabled=t,d.disabled=t},confirmCopy:L,destroy:()=>{s.remove(),l.remove(),f.remove(),N.remove()}}};var I=e=>{if(/^(#|rgb|hsl|oklch|oklab|lch|lab|color\(|hwb)/.test(e))return!0;let t=document.createElement(`span`);return t.style.color=e,t.style.color!==``};let L=e=>{let t=new Set,n=[],r=getComputedStyle(e);for(let e of Array.from(document.styleSheets)){let i;try{i=e.cssRules}catch{continue}let a=e=>{for(let i of Array.from(e))if(i instanceof CSSStyleRule)for(let e=0;e<i.style.length;e++){let a=i.style[e];if(a.startsWith(`--`)&&!t.has(a)){t.add(a);let e=r.getPropertyValue(a).trim();e&&n.push({name:a,value:e,isColor:I(e)})}}else `cssRules`in i&&a(i.cssRules)};a(i)}return n.sort((e,t)=>e.name.localeCompare(t.name)),n},R=(e,t,n)=>{let i=null,a=[],o=-1,s=null,c=0,l=0,u=()=>{i?.remove(),i=null,a=[],o=-1,s=null,e.removeAttribute(`aria-activedescendant`),e.setAttribute(`aria-expanded`,`false`)},d=t=>{a[o]&&a[o].setAttribute(`aria-selected`,`false`),o=t,a[o]&&(a[o].setAttribute(`aria-selected`,`true`),a[o].scrollIntoView({block:`nearest`}),e.setAttribute(`aria-activedescendant`,a[o].id))},f=()=>{let t=a[o];if(!t)return;let n=t.dataset.value,r=e.value.slice(0,c),i=e.value.slice(l);e.value=r+n+i,e.selectionStart=e.selectionEnd=c+n.length,e.dispatchEvent(new Event(`input`,{bubbles:!0})),u()},p=()=>{if(!i)return;let t=e.getBoundingClientRect();i.style.top=`${t.bottom+4}px`,i.style.left=`${t.left}px`,i.style.width=`${t.width}px`},m=()=>(i||(i=document.createElement(`div`),i.className=`kai-autocomplete`,i.setAttribute(`role`,`listbox`),i.id=`kai-ac-list`,t.appendChild(i),e.setAttribute(`aria-expanded`,`true`),e.setAttribute(`aria-controls`,`kai-ac-list`)),i.textContent=``,i),h=e=>{let t=n();if(!t)return;let r=L(t),i=e?r.filter(t=>t.name.includes(e)):r;if(!i.length){u();return}let s=m();a=i.slice(0,30).map((e,t)=>{let n=document.createElement(`div`);if(n.className=`kai-autocomplete-item`,n.setAttribute(`role`,`option`),n.setAttribute(`aria-selected`,`false`),n.id=`kai-ac-${t}`,n.dataset.value=e.name,e.isColor){let t=document.createElement(`span`);t.className=`kai-autocomplete-swatch`,t.style.background=e.value,n.appendChild(t)}let r=document.createElement(`span`);r.className=`kai-autocomplete-item-name`,r.textContent=e.name,n.appendChild(r);let i=document.createElement(`span`);return i.className=`kai-autocomplete-item-value`,i.textContent=e.value,n.appendChild(i),n.addEventListener(`pointerdown`,e=>{e.preventDefault(),o=t,f()}),n});for(let e of a)s.appendChild(e);p(),d(0)},g=e=>{let t=r(e);if(!t){u();return}let n=m(),i=document.createElement(`div`);i.className=`kai-autocomplete-rem`,i.setAttribute(`role`,`option`),i.setAttribute(`aria-selected`,`false`),i.id=`kai-ac-0`,i.dataset.value=t,i.textContent=`→ ${t}`,i.addEventListener(`pointerdown`,e=>{e.preventDefault(),o=0,f()}),a=[i],n.appendChild(i),p(),d(0)},_=()=>{let t=e.selectionStart,n=e.value.slice(0,t),r=n.match(/(\d+(?:\.\d+)?px)$/);if(r){s=`rem`,c=t-r[1].length,l=t,g(r[1]);return}let i=n.match(/(--[\w-]*)$/);if(i){s=`vars`,c=t-i[1].length,l=t,h(i[1]);return}s&&u()},v=e=>{i&&(e.key===`ArrowDown`?(e.preventDefault(),d(Math.min(o+1,a.length-1))):e.key===`ArrowUp`?(e.preventDefault(),d(Math.max(o-1,0))):e.key===`Tab`||e.key===`Enter`?o>=0&&(e.preventDefault(),f()):e.key===`Escape`&&(e.preventDefault(),u()))};return e.addEventListener(`input`,_),e.addEventListener(`keydown`,v),e.addEventListener(`blur`,()=>setTimeout(u,150)),{destroy:()=>{e.removeEventListener(`input`,_),e.removeEventListener(`keydown`,v),u()}}};var z=320,B=12,V=(e,t,n)=>{let r=n??t,i=n?4:8,a=document.documentElement.clientHeight-r.bottom,o=r.top,s=document.documentElement.clientHeight,c=a>=200||a>=o,l=c?r.bottom+i:r.top-i;requestAnimationFrame(()=>{let t=e.getBoundingClientRect().height,n=c?l:r.top-t-i;e.style.top=`${Math.max(B,Math.min(n,s-t-B))}px`});let u=Math.max(B,Math.min(r.left,document.documentElement.clientWidth-z-B));e.style.top=`${l}px`,e.style.left=`${u}px`};let H=(e,t)=>{let n=t.existingComment!=null,r=document.createElement(`div`);r.className=`kai-popover`,r.setAttribute(`role`,`dialog`),r.setAttribute(`aria-label`,n?`Edit annotation`:`Annotate element`);let i=document.createElement(`div`);i.className=`kai-popover-body`;let a=document.createElement(`div`);a.className=`kai-popover-path`,t.path.split(` › `).forEach((e,t)=>{t>0&&(a.appendChild(document.createElement(`wbr`)),a.appendChild(document.createTextNode(` › `))),e.split(/(?=[.#])/).forEach((e,t)=>{t>0&&a.appendChild(document.createElement(`wbr`)),a.appendChild(document.createTextNode(e))})});let o=document.createElement(`div`);o.className=`kai-popover-desc`;let s=f(t.element);s?o.textContent=`"${s}"`:o.style.display=`none`;let c=document.createElement(`textarea`);c.className=`kai-popover-textarea`,c.placeholder=`What should change?`,c.setAttribute(`aria-label`,`Annotation comment`),n&&(c.value=t.existingComment),i.appendChild(c),i.appendChild(a),i.appendChild(o);let l=document.createElement(`div`);l.className=`kai-popover-footer`;let u=()=>{let e=c.value.trim();e&&t.onSubmit(e)};if(n&&t.onDelete){let e=document.createElement(`button`);e.className=`kai-btn kai-btn--secondary`,e.textContent=`Delete`;let n=!1,r=null,i=()=>{n=!1,e.textContent=`Delete`,e.style.background=``,e.style.color=``,e.style.borderColor=``,r=null};e.addEventListener(`click`,()=>{n?(r&&clearTimeout(r),t.onDelete()):(n=!0,e.textContent=`Sure?`,e.style.background=`var(--color-danger)`,e.style.color=`var(--white)`,e.style.borderColor=`var(--color-danger)`,r=setTimeout(i,3e3))});let a=document.createElement(`div`);a.style.flex=`1`;let o=document.createElement(`button`);o.className=`kai-btn kai-btn--secondary`,o.textContent=`Cancel`,o.addEventListener(`click`,t.onClose);let s=document.createElement(`button`);s.className=`kai-btn kai-btn--primary`,s.textContent=`Save`,s.addEventListener(`click`,u),l.appendChild(e),l.appendChild(a),l.appendChild(o),l.appendChild(s)}else{let e=document.createElement(`button`);e.className=`kai-btn kai-btn--secondary`,e.textContent=`Cancel`,e.addEventListener(`click`,t.onClose);let n=document.createElement(`button`);n.className=`kai-btn kai-btn--primary`,n.textContent=`Add`,n.addEventListener(`click`,u),l.appendChild(e),l.appendChild(n)}c.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.metaKey||e.ctrlKey)&&(e.preventDefault(),u())}),r.appendChild(i),r.appendChild(l),e.appendChild(r),V(r,t.element.getBoundingClientRect(),t.anchorRect);let d=n=>{n.target!==e.host&&t.onClose()};window.addEventListener(`scroll`,d,{capture:!0,passive:!0});let p=n=>{n.composedPath().includes(e.host)||t.onClose()};document.addEventListener(`pointerdown`,p,{capture:!0});let m=()=>t.onClose();window.addEventListener(`resize`,m);let h=e.activeElement??document.activeElement;requestAnimationFrame(()=>c.focus());let g=R(c,e,()=>t.element);return r.addEventListener(`keydown`,n=>{n.key===`Escape`&&!e.querySelector(`.kai-autocomplete`)&&t.onClose()}),{destroy:()=>{window.removeEventListener(`scroll`,d,{capture:!0}),document.removeEventListener(`pointerdown`,p,{capture:!0}),window.removeEventListener(`resize`,m),g.destroy(),r.remove(),h instanceof HTMLElement&&h.focus()}}};var U=new DOMParser,W=22,G=4,K=8,q=9,J=(e,t)=>({top:Math.max(G+q,Math.min(e,document.documentElement.clientHeight-W-G)),left:Math.max(G,Math.min(t,document.documentElement.clientWidth-W-q-G))}),Y=()=>{let e=U.parseFromString(y,`image/svg+xml`),t=document.importNode(e.documentElement,!0);return t.setAttribute(`width`,`12`),t.setAttribute(`height`,`12`),t.setAttribute(`stroke-width`,`2.5`),t},X=e=>{if(e.length===0)return[];let t=Array(e.length).fill(!1),n=[];for(let r=0;r<e.length;r++){if(t[r])continue;let i=[],a=[r];for(t[r]=!0;a.length>0;){let n=a.shift();i.push(e[n]);for(let r=0;r<e.length;r++){if(t[r])continue;let i=e[n].left-e[r].left,o=e[n].top-e[r].top;Math.sqrt(i*i+o*o)<W+q&&(t[r]=!0,a.push(r))}}n.push(i)}return n};let ee=(e,t,n,r)=>{let i=new Map,a=new Map,o=new Set,s=[],c=0,l=null,u=null,d=null,f=!1,p=new Map,m=new Map,h=null,g=null,_=null,v=null,y=[],b=null,x=null,S=(e=!1)=>{if(v!==null&&(cancelAnimationFrame(v),v=null),_?.(),_=null,!h)return;let t=g;if(g=null,e){let e=h;h=null;let n=Array.from(e.querySelectorAll(`.kai-stack-expanded-marker`));y.forEach(e=>e.cancel()),y=[];let r=e.style.flexDirection===`row-reverse`?`8px`:`-8px`,i=n.map((e,t)=>e.animate([{transform:`translateX(0) scale(1)`,opacity:1},{transform:`translateX(${r}) scale(0.8)`,opacity:0}],{duration:150,easing:`ease-in`,delay:t*30,fill:`forwards`}));y=i;let a=e.querySelector(`.kai-tooltip`);a&&(a.style.display=`none`),Promise.all(i.map(e=>e.finished)).then(()=>{if(e.remove(),i.forEach(e=>e.cancel()),y=[],t){let e=t.querySelector(`.kai-marker-stack-badge`);e&&(x?.cancel(),x=e.animate([{transform:`translate(50%, -50%) scale(0)`},{transform:`translate(50%, -50%) scale(1)`}],{duration:400,easing:w,fill:`forwards`})),t.classList.add(`kai-marker-stack--has-badge`),b?.cancel(),b=t.animate([{opacity:.4},{opacity:1}],{duration:400,easing:w,fill:`forwards`})}}).catch(()=>{e.remove()})}else y.forEach(e=>e.cancel()),y=[],x?.cancel(),x=null,b?.cancel(),b=null,t&&t.classList.add(`kai-marker-stack--has-badge`),h.remove(),h=null},C=(i,a)=>{S();let o=document.createElement(`div`);o.className=`kai-stack-expanded`;let s=document.createElement(`div`);s.className=`kai-tooltip`,s.style.display=`none`,s.style.fontFamily=`var(--font-sans)`;let c=i.getBoundingClientRect(),l=document.documentElement.clientWidth,u=l-c.right>=c.left;o.style.flexDirection=u?`row`:`row-reverse`,u?o.style.left=`${c.right+6}px`:o.style.right=`${l-c.left+6}px`,o.style.top=`${c.top}px`;let d=[];for(let e of a){let a=document.createElement(`button`);a.className=`kai-stack-expanded-marker`;let c=Y();a.appendChild(c),a.addEventListener(`click`,n=>{n.stopPropagation(),S(!0),t(e,i.getBoundingClientRect())}),a.addEventListener(`mouseenter`,()=>{n?.(e.id),s.textContent=e.comment.trim()||e.path||e.selector,s.style.display=``;let t=a.getBoundingClientRect();s.style.left=`${t.left+t.width/2}px`,s.style.transform=`translateX(-50%)`,s.style.top=`${t.bottom+6}px`,s.style.bottom=`auto`}),a.addEventListener(`mouseleave`,()=>{r?.(e.id),s.style.display=`none`}),o.appendChild(a),d.push(a)}o.appendChild(s),e.appendChild(o),h=o,g=i;let f=i.querySelector(`.kai-marker-stack-badge`);f&&(x?.cancel(),x=f.animate([{transform:`translate(50%, -50%) scale(1)`},{transform:`translate(50%, -50%) scale(0)`}],{duration:200,easing:`ease-out`,fill:`forwards`})),i.classList.remove(`kai-marker-stack--has-badge`),b?.cancel(),b=i.animate([{opacity:1},{opacity:.4}],{duration:200,easing:`ease-out`,fill:`forwards`}),y.forEach(e=>e.cancel()),y=[],requestAnimationFrame(()=>{let e=u?`-12px`:`12px`;for(let t=0;t<d.length;t++){let n=d[t].animate([{transform:`translateX(${e}) scale(0.8)`,opacity:0},{transform:`translateX(0) scale(1)`,opacity:1}],{duration:400,easing:w,delay:t*50,fill:`both`});y.push(n)}});let p=e=>{if(!h)return;let t=e.target;!h.contains(t)&&t!==i&&!i.contains(t)&&S(!0)},m=t=>{h&&t.target!==e.host&&S(!0)},C=()=>{h&&S(!0)},T=e=>{e.key===`Escape`&&S(!0)};v=requestAnimationFrame(()=>{v=null,h&&(e.addEventListener(`click`,p,!0),document.addEventListener(`click`,m),window.addEventListener(`scroll`,C,!0),document.addEventListener(`keydown`,T))}),_=()=>{e.removeEventListener(`click`,p,!0),document.removeEventListener(`click`,m),window.removeEventListener(`scroll`,C,!0),document.removeEventListener(`keydown`,T)}},T=(i,a)=>{let o=p.get(i);if(o){let e=o.querySelector(`.kai-marker-stack-badge`);return e&&(e.textContent=String(a)),o}let c=document.createElement(`div`);c.className=f?`kai-marker-stack kai-marker-stack--has-badge`:`kai-marker-stack kai-marker-stack--has-badge kai-marker-stack--inactive`,c.appendChild(Y());let l=document.createElement(`span`);return l.className=`kai-marker-stack-badge`,l.textContent=String(a),c.appendChild(l),c.addEventListener(`click`,e=>{if(e.stopPropagation(),!f)return;if(g===c){S(!0);return}let n=(c.dataset.annotationIds?.split(`,`)||[]).map(e=>s.find(t=>t.id===e)).filter(e=>!!e);n.length===1?t(n[0],c.getBoundingClientRect()):n.length>1&&C(c,n)}),c.addEventListener(`mouseenter`,()=>{let e=c.dataset.annotationIds?.split(`,`)||[];for(let t of e)n?.(t)}),c.addEventListener(`mouseleave`,()=>{let e=c.dataset.annotationIds?.split(`,`)||[];for(let t of e)r?.(t)}),e.appendChild(c),p.set(i,c),c},E=()=>{let e=[];for(let t of s){let n=i.get(t.id);if(!n)continue;let r=document.querySelector(t.selector);if(!r){n.style.display=`none`;let e=a.get(t.id);e&&(e.style.display=`none`);continue}let s=r.getBoundingClientRect(),c=J(s.top-K,s.right-K);e.push({annotation:t,marker:n,top:c.top,left:c.left});let l=a.get(t.id);l&&(o.has(t.id)?(l.style.display=`block`,l.style.top=`${s.top-4}px`,l.style.left=`${s.left-4}px`,l.style.width=`${s.width+8}px`,l.style.height=`${s.height+8}px`):l.style.display=`none`)}let t=X(e),n=new Set;m.clear();for(let e of t)if(e.length===1){let{marker:t,top:n,left:r}=e[0];t.style.display=`flex`,t.style.top=`${n}px`,t.style.left=`${r}px`}else{let t=e.map(e=>e.annotation.id).sort().join(`,`);n.add(t);let r=0,i=0;for(let n of e)r+=n.top,i+=n.left,n.marker.style.display=`none`,m.set(n.annotation.id,t);r/=e.length,i/=e.length;let a=J(r,i),o=T(t,e.length);o.dataset.annotationIds=t,o.style.top=`${a.top}px`,o.style.left=`${a.left}px`}for(let[e,t]of p)n.has(e)||(t===g&&S(!1),t.remove(),p.delete(e));if(d&&l&&u){let e=d.getBoundingClientRect(),t=J(e.top-K,e.right-K);l.style.top=`${t.top}px`,l.style.left=`${t.left}px`,u.style.top=`${e.top-4}px`,u.style.left=`${e.left-4}px`,u.style.width=`${e.width+8}px`,u.style.height=`${e.height+8}px`}c=requestAnimationFrame(E)},D=o=>{s=o;let c=new Set(o.map(e=>e.id));for(let[e,t]of i)c.has(e)||(t.remove(),i.delete(e));for(let[e,t]of a)c.has(e)||(t.remove(),a.delete(e));o.forEach(o=>{let s=i.get(o.id);s||(s=document.createElement(`div`),s.className=f?`kai-marker`:`kai-marker kai-marker--inactive`,s.setAttribute(`role`,`button`),s.setAttribute(`tabindex`,`0`),s.addEventListener(`click`,e=>{e.stopPropagation();let n=e.currentTarget;t(o,n.getBoundingClientRect())}),s.addEventListener(`mouseenter`,()=>n?.(o.id)),s.addEventListener(`mouseleave`,()=>r?.(o.id)),e.appendChild(s),i.set(o.id,s)),s.querySelector(`svg`)||s.appendChild(Y()),s.setAttribute(`aria-label`,`Annotation: ${o.comment.slice(0,50)}`);let c=a.get(o.id);c||(c=document.createElement(`div`),c.className=`kai-annotation-box`,e.appendChild(c),a.set(o.id,c))})},O=()=>{l?.remove(),u?.remove(),l=null,u=null,d=null};return c=requestAnimationFrame(E),{update:D,showPreview:t=>{O();let n=t.getBoundingClientRect(),r=document.createElement(`div`);r.className=`kai-annotation-box`,r.style.top=`${n.top-4}px`,r.style.left=`${n.left-4}px`,r.style.width=`${n.width+8}px`,r.style.height=`${n.height+8}px`,e.appendChild(r);let i=document.createElement(`div`);i.className=`kai-marker`,i.appendChild(Y()),i.style.pointerEvents=`none`;let a=J(n.top-K,n.right-K);return i.style.top=`${a.top}px`,i.style.left=`${a.left}px`,e.appendChild(i),l=i,u=r,d=t,new DOMRect(a.left,a.top,W,W)},clearPreview:O,showBox:e=>{o.add(e)},hideBox:e=>{o.delete(e)},setActive:e=>{f=e;for(let t of i.values())t.classList.toggle(`kai-marker--inactive`,!e);for(let t of p.values())t.classList.toggle(`kai-marker-stack--inactive`,!e);e||S()},destroy:()=>{cancelAnimationFrame(c),O(),S();for(let e of i.values())e.remove();i.clear();for(let e of a.values())e.remove();a.clear();for(let e of p.values())e.remove();p.clear(),m.clear()},getMarkerRect:e=>{let t=m.get(e);if(t){let e=p.get(t);if(e)return e.getBoundingClientRect()}return i.get(e)?.getBoundingClientRect()}}};var Z=e=>{let t=document.createElement(`div`);return t.className=e,t.style.display=`none`,t};let te=e=>{let t=Z(`kai-measure-line kai-measure-line--v`),n=Z(`kai-measure-line kai-measure-line--h`),r=Z(`kai-measure-cross`),i=Z(`kai-measure-tooltip`),a=Z(`kai-measure-text-tooltip`),o=Z(`kai-measure-selection`),s=Z(`kai-measure-highlight`),c=[t,n,r,i,a,o,s];for(let t of c)e.appendChild(t);let l=()=>{for(let e of c)e.style.display=`none`};return{showCrosshair:e=>{let{cx:c,cy:l,left:u,right:d,top:f,bottom:p,width:m,height:h}=e,g=p-f;g>0?(t.style.display=`block`,t.style.left=`${c}px`,t.style.top=`${f}px`,t.style.height=`${g}px`):t.style.display=`none`;let _=d-u;_>0?(n.style.display=`block`,n.style.left=`${u}px`,n.style.top=`${l}px`,n.style.width=`${_}px`):n.style.display=`none`,r.style.display=`block`,r.style.left=`${c}px`,r.style.top=`${l}px`,i.textContent=`${Math.round(m)}×${Math.round(h)} px`,i.style.display=`block`;let v=window.innerWidth,y=window.innerHeight,b=c+12+100<v,x=l+12+24<y;i.style.left=b?`${c+12}px`:``,i.style.right=b?``:`${v-c+12}px`,i.style.top=x?`${l+12}px`:``,i.style.bottom=x?``:`${y-l+12}px`,a.style.display=`none`,o.style.display=`none`,s.style.display=`none`},showTextInfo:(e,t,n)=>{l(),a.textContent=``,[[`Font`,n.fontFamily],[`Size`,n.fontSize],[`Weight`,n.fontWeight],[`Line`,n.lineHeight],[`Color`,n.color],[`Track`,n.letterSpacing]].forEach(([e,t],n)=>{n>0&&a.appendChild(document.createTextNode(`
`));let r=document.createElement(`span`);r.className=`kai-tt-label`,r.textContent=e,a.appendChild(r),a.appendChild(document.createTextNode(t))}),a.style.display=`block`;let r=window.innerWidth,i=window.innerHeight,o=e+14+280<r,s=t+14+120<i;a.style.left=o?`${e+14}px`:``,a.style.right=o?``:`${r-e+14}px`,a.style.top=s?`${t+14}px`:``,a.style.bottom=s?``:`${i-t+14}px`},showSelection:(e,c,l,u)=>{let d=Math.min(e,l),f=Math.min(c,u),p=Math.abs(l-e),m=Math.abs(u-c);o.style.display=`block`,o.style.left=`${d}px`,o.style.top=`${f}px`,o.style.width=`${p}px`,o.style.height=`${m}px`,t.style.display=`none`,n.style.display=`none`,r.style.display=`none`,i.style.display=`none`,a.style.display=`none`,s.style.display=`none`},showHighlight:e=>{s.style.display=`block`,s.style.left=`${e.left}px`,s.style.top=`${e.top}px`,s.style.width=`${e.width}px`,s.style.height=`${e.height}px`,i.textContent=`${Math.round(e.width)}×${Math.round(e.height)} px`,i.style.display=`block`,i.style.left=`${e.left+e.width/2}px`,i.style.top=`${e.top+e.height/2}px`,i.style.right=``,i.style.bottom=``,i.className=`kai-measure-tooltip kai-measure-tooltip--centered`,t.style.display=`none`,n.style.display=`none`,r.style.display=`none`,a.style.display=`none`,o.style.display=`none`},hide:()=>{l(),i.className=`kai-measure-tooltip`},destroy:()=>{for(let e of c)e.remove()}}};var Q=/Mac|iPhone|iPad/.test(navigator.platform??navigator.userAgent),ne={alt:Q?`⌥`:`Alt`,shift:Q?`⇧`:`Shift`},re={annotate:{text:`Click elements to annotate`,keys:[`alt`],hint:`inspect mode`},measure:{text:`Drag to measure`,keys:[`alt`,`shift`],hint:`text info`}},$=(e,t=[])=>{let n=document.createDocumentFragment(),{text:r,keys:i,hint:a}=re[e],o=document.createElement(`span`);o.textContent=r,n.appendChild(o);let s=document.createElement(`span`);s.className=`kai-guide-bar-sep`,s.textContent=`·`,n.appendChild(s);for(let e of i){let r=document.createElement(`span`);r.className=`kai-guide-bar-kbd`,r.setAttribute(`data-key`,e),t.includes(e)&&r.setAttribute(`data-pressed`,``),r.textContent=ne[e],n.appendChild(r)}let c=document.createElement(`span`);return c.className=`kai-guide-bar-hint`,c.textContent=a,n.appendChild(c),n};let ie=e=>{let t=null,n=null,r=null,i=null,a=!1,o=document.createElement(`div`);o.className=`kai-guide-bar`,o.setAttribute(`aria-hidden`,`true`),o.style.display=`none`;let s=document.createElement(`div`);s.className=`kai-guide-bar-content`,o.appendChild(s),e.appendChild(o);let c=[],l=e=>{if(!a)return;c=e;let t=s.querySelectorAll(`.kai-guide-bar-kbd`);for(let n of t){let t=n.getAttribute(`data-key`);e.includes(t)?n.setAttribute(`data-pressed`,``):n.removeAttribute(`data-pressed`)}};return{show:(e,u=[])=>{if(c=u,a&&t===e){l(u);return}n?.cancel(),r?.cancel(),i?.cancel(),a?(t=e,r=s.animate([{opacity:1,transform:`translateY(0)`},{opacity:0,transform:`translateY(-4px)`}],{duration:150,easing:`ease-out`,fill:`forwards`}),r.finished.then(()=>{let t=o.getBoundingClientRect().width;s.replaceChildren($(e,c));let n=o.getBoundingClientRect().width;t!==n&&(i?.cancel(),i=o.animate([{width:`${t}px`},{width:`${n}px`}],{duration:250,easing:`linear(0, 0.012 0.9%, 0.05 2%, 0.411 9.2%, 0.517 11.8%, 0.611 14.6%, 0.694 17.7%, 0.765 21.1%, 0.824 24.8%, 0.872 28.9%, 0.91 33.4%, 0.939 38.4%, 0.977 50.9%, 0.994 68.4%, 1)`,fill:`forwards`}),i.finished.then(()=>{i?.cancel(),i=null}).catch(()=>{})),r=s.animate([{opacity:0,transform:`translateY(4px)`},{opacity:1,transform:`translateY(0)`}],{duration:200,easing:`ease-out`,fill:`forwards`})}).catch(()=>{})):(a=!0,t=e,o.style.display=``,s.replaceChildren($(e,c)),n=o.animate([{transform:`translateX(-50%) scale(0.8) translateY(-8px)`,opacity:0},{transform:`translateX(-50%) scale(1) translateY(0)`,opacity:1}],{duration:400,easing:w,fill:`forwards`}))},hide:()=>{a&&(a=!1,t=null,n?.cancel(),r?.cancel(),i?.cancel(),n=o.animate([{transform:`translateX(-50%) scale(1) translateY(0)`,opacity:1},{transform:`translateX(-50%) scale(0.9) translateY(-6px)`,opacity:0}],{duration:200,easing:`ease-out`,fill:`forwards`}),n.finished.then(()=>{a||(o.style.display=`none`)}).catch(()=>{}))},updateKeys:l,destroy:()=>{n?.cancel(),r?.cancel(),i?.cancel(),o.remove()}}};var ae=5,oe=class extends HTMLElement{shadow;annotations=[];active=!1;fabCorner;altHeld=!1;shiftHeld=!1;dragging=!1;dragStart=null;lastMousePos={x:0,y:0};measureRafId=null;highlightLocked=!1;fab;overlay;inspector;markers;guideBar;activePopover=null;activePopoverAnnotationId=null;hoveredElement=null;handleMouseOver;handleMouseOut;handleClick;handleGlobalKeydown;handleKeydown;handleKeyup;handleWindowBlur;handleMouseMove;handleMouseDown;handleMouseUp;constructor(){super(),this.shadow=this.attachShadow({mode:`closed`});let e=document.createElement(`style`);e.textContent=`
:host {
  --white: oklch(100% 0 0);
