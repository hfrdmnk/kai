...
<text x="12" y="17" text-anchor="middle" font-family="sans-serif" font-size="18" font-weight="700" fill="currentColor">回</text>
</svg>`;
...
export const iconTrash = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const iconChevron = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 4L16 12L8 20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
</svg>`;
